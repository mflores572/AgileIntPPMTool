...
public class ProjectTaskService {
	...
	public ProjectTask addProjectTask(String projectIdentifier, ProjectTask projectTask) {
		...
		try {
			...
			if (projectTask.getPriority() == 0 || projectTask.getPriority() == null) {// In the future we need to "projectTask.getPriority()==0" to handle
													// the form
	...
	public ProjectTask findPTByProjectSequence(String backlog_id, String pt_id) {
    	...
    	//make sure that the backlog/projectId in the path corresponds to the right project
